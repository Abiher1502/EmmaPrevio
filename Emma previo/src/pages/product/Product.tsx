...
import { catalogMen, catalogwomen, catalogJoyeria, catalogPREMIUM, catalogvestidos, catalogCamisas, catalogTops, catalogBlazers, catalogPantalones, catalogTrajesdebaño, catalogRopadeportiva,catalogDAZYsueters, catalogConjuntos, catalogCurvy, catalogZapatos, catalogAretes, catalogCollares, catalogPlayeras, catalogAccesorios, catalogChamarras,catalogPulceras,} from '../../data/catalog';
...
const ProductPage = () => {
    ...
    useEffect(() => {
        const result = [...catalogMen, ...catalogwomen, ...catalogJoyeria, ...catalogvestidos, ...catalogPREMIUM, ...catalogCamisas, ...catalogTops, ...catalogBlazers, ...catalogPantalones, ...catalogTrajesdebaño, ...catalogRopadeportiva, ...catalogDAZYsueters, ...catalogConjuntos, ...catalogCurvy, ...catalogZapatos, ...catalogAretes, ...catalogCollares, ...catalogCollares, ...catalogPulceras, ...catalogAccesorios, ...catalogChamarras, ...catalogPlayeras].find((product) => {
